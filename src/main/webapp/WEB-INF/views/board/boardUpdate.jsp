...
<form 
	...
	<tr>
		<th>제 목</th>
		<td><input type="text" name="title" value="<%= board.getTitle().replace("\"", "$quot;") %>" required></td>
	</tr>
	<tr>
		<th>작성자</th>
		<td>
	...
	<tr>
		<th>내 용</th>
		<td><textarea rows="5" cols="40" name="content"><%= HelloMvcUtils.escapeXml(board.getContent()) %></textarea></td>
	</tr>
	<tr>
		<th colspan="2">
