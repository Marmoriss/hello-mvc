...
<section id=enroll-container>
    ...
    <!-- action을 적지 않으면 현재 페이지 url로 넘어감 -->
		<table>
			<tr>
				<th>아이디<sup>*</sup></th>
				<td>
			...
			<tr>
				<th>패스워드<sup>*</sup></th>
				<td>
					<input type="password" name="password" id="_password" value="0000" required><br>
				</td>
			</tr>
			<tr>
				<th>패스워드확인<sup>*</sup></th>
				<td>	
					<input type="password" id="passwordCheck" value="0000" required><br>
				</td>
			</tr>  
			<tr>
				<th>이름<sup>*</sup></th>
			...
			<tr>
				<th>휴대폰<sup>*</sup></th>
				<td>	
					<input type="tel" placeholder="(-없이)01012345678" name="phone" id="phone" maxlength="11" value="01000000000" required><br>
				</td>
			</tr>
			<tr>
				<th>성별 </th>
 ...
 */
 document.memberEnrollFrm.onsubmit = (e) => {
     ...
     if(!/^[a-zA-Z0-9!@#$%^&*()]{4,}$/.test(password.value)){
         alert("비밀번호는 영문자/숫자/!@#$%^&*()로 최소 4글자 이상이어야합니다.")
         password.select();
         return false;
     }
